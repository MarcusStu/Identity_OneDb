...
namespace MarcusOneDbTest.Controllers
{
    public class PeopleController : Controller
    {
        ...
        {
            var persons = db.Persons.Include(p => p.City);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,CityID,AddedById,AddedByUserName")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,CityID,AddedById,AddedByUserName")] Person person)
        {
            if (ModelState.IsValid)
            {
